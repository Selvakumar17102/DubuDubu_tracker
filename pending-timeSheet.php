...
if(isset($_POST['del_submit'])){
	$del_id = $_POST['delid'];
	$delSql = "DELETE FROM time_sheet WHERE id = $del_id";
	if($conn->query($delSql) == TRUE){
		$msg='<div class="alert alert-danger">Project Deleted Successfully !</div>';
	}
}
...
<head>
	...
	<title>Dubu Dubu - Pending Sheet</title>
			...
			<div class="ec-content-wrapper">
				<div class="content">
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						<div>
							<h1>Pending Time Sheet</h1>
							<p class="breadcrumbs"><span><a href="index.php">Home</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Pending Time Sheet</p>
						</div>
					</div>
						...
						<div class="col-12">
							<div class="card card-default">
								<div class="card-header card-header-border-bottom">
                                        <h2 style="text-align: center">Pending Time Sheet List</h2>
								</div>
								<div class="card-body">
									<div class="table-responsive">
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody>
												...
												LEFT OUTER JOIN project b ON a.project_id = b.id
												LEFT OUTER JOIN task c ON a.task_id = c.id WHERE time_sheet_status = 1";
                                                ...
                                                while($projectRow = mysqli_fetch_array($projectResult)){
													...
													<tr>
														...
														<button type="button" data-toggle="modal" data-target="#del<?php echo $projectRow['id'];?>"><span class="mdi mdi-delete-empty"></span></button>
														...
														<div class="modal fade show" id="del<?php echo $projectRow['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  aria-modal="true">
					                    					        							...
					                    					        							<form method="post" class="row g-3" enctype="multipart/form-data">
					                    					        					            <div class="col-md-12">
					                    					        					                <div class="form-group mb-4">
																											<p>Are you sure to delete the <strong><?php echo $projectRow['task_name'];?></strong> task Time Sheet !</p>
					                    					        					                </div>
					                    					        					            </div>
																									<input type="hidden" name="delid" value="<?php echo $projectRow['id'];?>">
					                    					        								<div class="modal-footer px-4">
																										<button class="btn btn-light" data-dismiss="modal"> Cancel</button>
					                    					        									<button type="submit" name="del_submit" id="del_submit" class="btn btn-danger">Delete</button>
					                    					        								</div>
					                    					        							</form>
					                    					        						</div>
					                    					        					</div>
